...
from backtrader.ctp.ctpstore import CtpStore
from backtrader.ctp.ctpfeed import CtpData
...
def runstrategy():
    ...
    if args.data1 is not None:
        if args.data1 != args.data0:
            storekwargs['timeframe'] = datatf1
            storekwargs['compression'] = datacomp1
            data1 = DataFactory(dataname=args.data1, **storekwargs)
        else:
            data1 = data0
